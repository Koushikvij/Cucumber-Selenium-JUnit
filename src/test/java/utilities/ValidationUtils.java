...
public class ValidationUtils
{
    ...
    public static synchronized boolean compareInput(WebElement element, String str)
    {
        ...
        {
        	Assert.assertTrue("Text does not match to <b>" + str + "</b>" + " " + "Actual text is : " + element.getText(),false);
            e.printStackTrace();
            return false;
        }
        return false;
    ...
    public static synchronized boolean compareText(WebElement element, String str)
    {
        ...
        {
        	Assert.assertTrue("Element does not exist",false);
            ex.printStackTrace();
            return false;
        }
    }
    ...
    public static synchronized boolean CheckElementExists(WebElement element)
    {
        try
        {
            ...
            if(Helper.getDriver().findElements(byval).size() > 0)
            {
        ...
        catch(NoSuchElementException e)
        {
           Log.error(ExceptionUtils.getStackTrace(e));
       		Assert.assertTrue("Verify " +  element + " exists in DOM",false);
        }
        return false;
    }
...
//				win.add(winHandle);
    ...
    public static boolean VerifyLinkIsBroken(String linkUrl)
    {
        ...
        {
        	Assert.assertTrue("Verify if the link is broken" + " " +"Link is broken : " + linkUrl,true);
            e.printStackTrace();
        }
        return broken;
    }
